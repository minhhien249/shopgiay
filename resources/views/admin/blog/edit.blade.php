                ...
                @method('PUT')
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input value="{{ $blog->title }}" type="text" class="form-control" id="name" name="name" placeholder="Nhập tên tiêu đề">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $blog->user_id }}" type="text" class="form-control" id="user_id" name="user_id" placeholder="Url">
                            </div>
                            <div class="form-group">
