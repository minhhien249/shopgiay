...
<!-- Mirrored from themes.pixelstrap.com/bigdeal/html/layout-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 May 2020 12:57:34 GMT -->
<head>
    ...
    <link rel="icon" href="shop/assets/images/favicon/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="shop/assets/images/favicon/favicon.ico" type="image/x-icon">
    ...
    <!--icon css-->
    <link rel="stylesheet" type="text/css" href="shop/assets/css/font-awesome.css">
    <link rel="stylesheet" type="text/css" href="shop/assets/css/themify.css">

    <!--Slick slider css-->
    <link rel="stylesheet" type="text/css" href="shop/assets/css/slick.css">
    <link rel="stylesheet" type="text/css" href="shop/assets/css/slick-theme.css">

    <!--Animate css-->
    <link rel="stylesheet" type="text/css" href="shop/assets/css/animate.css">
    <!-- Bootstrap css -->
    <link rel="stylesheet" type="text/css" href="shop/assets/css/bootstrap.css">

    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="shop/assets/css/color3.css" media="screen" id="color">
</head>
<body class="bg-light">
...
<div class="loader-wrapper">
    <div>
        <img src="shop/assets/images/loader.gif" alt="loader">
    </div>
</div>
<!-- loader end -->
            ...
            <div class="col-lg-4 col-md-6">
                <div class="row banner-2-padding collection4">
                    <div class="col-6 ">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="shop/assets/images/layout-3/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                    ...
                    <div class="col-6 ">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="shop/assets/images/layout-3/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain">
                                <div>
                                    <h3>canon</h3>
                ...
                <div class="row banner-3-padding collection4">
                    <div class="col-6 ">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="shop/assets/images/layout-3/collection-banner/3.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>new</h3>
                    ...
                    <div class="col-6">
                        <div class="collection-banner-main banner-2">
                            <div class="collection-img">
                                <img src="shop/assets/images/layout-3/collection-banner/4.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>boys</h3>
                ...
                <div class="row ">
                    <div class="col-12">
                        <div class="collection-banner-main banner-3 p-center ">
                            <div class="collection-img">
                                <img src="shop/assets/images/layout-3/collection-banner/5.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                ...
                <div class="row banner-2-padding  collection5 ">
                    <div class="col-lg-12 col-md-6 ">
                        <div class="collection-banner-main banner-4 p-left">
                            <div class="collection-img">
                                <img src="shop/assets/images/layout-3/collection-banner/6.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>lG</h3>
                    ...
                    <div class="col-lg-12 col-md-6 ">
                        <div class="collection-banner-main banner-4 p-left">
                            <div class="collection-img">
                                <img src="shop/assets/images/layout-3/collection-banner/7.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div >
                                    <h3>jewellery</h3>
        ...
        <div class="row">
            <div class="col-12">
                <div class="discount-banner-contain  ">
                    ...
                    <h1><span>OMG! Just Look </span> at the<span> great Deals!</span></h1>
                            ...
                            <div class="product-slide-6 product-m no-arrow">
                                    ...
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/1.jpg" class="img-fluid  " alt="product">
                                            </div>
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/2.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/3.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/4.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/5.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/6.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/7.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="shop/assets/images/layout-3/product/8.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon icon-center">
                                                <div>
                                                    <button  onclick="openCart()" type="button" >
        ...
        <div class="row layout-3-hotdeal">
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                <div class="media-banner banner-inverse b-g-white1 border-0">
                    ...
                    <div class="media-banner-box">
                        <div class="media">
                            <img src="shop/assets/images/layout-1/media-banner/1.jpg" class="img-fluid  " alt="banner">
                            <div class="media-body">
                    ...
                    <div class="media-banner-box">
                        <div class="media">
                            <img src="shop/assets/images/layout-1/media-banner/2.jpg" class="img-fluid  " alt="banner">
                            <div class="media-body">
                                <div class="media-contant">
                                    <div>
                                        <div class="rating">
            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                <div class="media-banner b-g-white1 border-0 banner-inverse">
                    <div class="media-banner-box">
                        <div class="media-heading">
                            <h5>on sale</h5>
                        </div>
                    ...
                    <div class="media-banner-box">
                        <div class="media">
                            <img src="shop/assets/images/layout-1/media-banner/3.jpg" class="img-fluid  " alt="banner">
                            <div class="media-body">
                                <div class="media-contant">
                                    <div>
                                        <div class="rating">
                    ...
                    <div class="media-banner-box">
                        <div class="media">
                            <img src="shop/assets/images/layout-1/media-banner/4.jpg" class="img-fluid
                         " alt="banner">
                            <div class="media-body">
                                <div class="media-contant">
                                    <div>
                                ...
                                <div class="row hot-deal-subcontain">
                                    <div class="col-lg-4 col-sm-3 ">
                                        <div class="hotdeal-right-slick-1 no-arrow">
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/5.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/7.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2  col-sm-2">
                                        <div class="hotdeal-right-nav-1">
                                            <div><img src="shop/assets/images/layout-3/hot-deal/5.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="shop/assets/images/layout-3/hot-deal/7.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="shop/assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="shop/assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid   "></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row hot-deal-subcontain">
                                    <div class="col-lg-4 col-sm-3">
                                        <div class="hotdeal-right-slick-1 no-arrow">
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/6.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            <div class="right-slick-img"><img src="shop/assets/images/layout-3/hot-deal/3.jpg" alt="hot-deal" class="img-fluid  "></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-7">
                                        <div class="hot-deal-center">
                                    ...
                                    <div class="col-lg-2  col-sm-2 ">
                                        <div class="hotdeal-right-nav-1">
                                            <div><img src="shop/assets/images/layout-3/hot-deal/2.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="shop/assets/images/layout-3/hot-deal/1.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="shop/assets/images/layout-3/hot-deal/6.jpg" alt="hot-deal" class="img-fluid   "></div>
                                            <div><img src="shop/assets/images/layout-3/hot-deal/3.jpg" alt="hot-deal" class="img-fluid   "></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section class="collection-banner section-pb-space layout-3">
    <div class="custom-container">
        <div class="row layout-3-collection">
            <div class="col-md-6 ">
                <div class="collection-banner-main banner-7 p-left">
                    <div class="collection-img">
                        <img src="shop/assets/images/layout-3/collection-banner/11.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>Video Camera</h3>
            ...
            <div class="col-md-6">
                <div class="collection-banner-main banner-7 p-left">
                    <div class="collection-img">
                        <img src="shop/assets/images/layout-3/collection-banner/12.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>Furniture</h3>
...
<section class="rounded-category section-mb-space">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="slide-6 no-arrow">
                        ...
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="shop/assets/images/layout-1/rounded-cat/1.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="shop/assets/images/layout-1/rounded-cat/2.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Furniture
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="shop/assets/images/layout-1/rounded-cat/3.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Bag
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="shop/assets/images/layout-1/rounded-cat/4.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Tools
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="shop/assets/images/layout-1/rounded-cat/5.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Grocery
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="shop/assets/images/layout-1/rounded-cat/6.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        camera
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="shop/assets/images/layout-1/rounded-cat/7.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        cardigans
        ...
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="shop/assets/images/layout-3/collection-banner/8.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>men</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="shop/assets/images/layout-3/collection-banner/9.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>sport</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1">
                    <div class="collection-img">
                        <img src="shop/assets/images/layout-3/collection-banner/10.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                            <h3>army</h3>
                ...
                <div class="slide-1 no-arrow">
                        ...
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="shop/assets/images/testimonial/1.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="shop/assets/images/testimonial/2.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="shop/assets/images/testimonial/3.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
...
<!--instagram start-->
<section class="instagram section-pb-space">
    <div class="container-fluid">
        <div class="row">
            <div class="col p-0">
                    ...
                    <div class="slide-7 no-arrow">
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/1.jpg" class="img-fluid  " alt="insta">
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/2.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/3.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/4.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/5.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/6.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/7.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="shop/assets/images/insta/8.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col">
                <div class="contact-banner-contain">
                    <div class="contact-banner-img"><img src="shop/assets/images/layout-1/call-img.png" alt="contact-banner"></div>
                ...
                <div class="row sosiyal-contain">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="app-link-group">
                            <div class="app-item">
                                <img src="shop/assets/images/layout-1/app/1.png" class="img-fluid" alt="app">
                            </div>
                            <div class="app-item">
                                <img src="shop/assets/images/layout-1/app/2.png" class="img-fluid" alt="app">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-box">
                            ...
                            <div class="footer-contant mobile-contant">
                                <div class="logo-img">
                                    <img src="shop/assets/images/layout-3/logo/logo2.png" class="img-fluid  " alt="logo">
                                </div>
                                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature. </p>
                                <ul class="paymant-bottom">
                                    <li><a href="#"><img src="shop/assets/images/layout-1/pay/1.png" class="img-fluid" alt="payment"></a></li>
                                    <li><a href="#"><img src="shop/assets/images/layout-1/pay/2.png" class="img-fluid" alt="payment"></a></li>
                                    <li><a href="#"><img src="shop/assets/images/layout-1/pay/3.png" class="img-fluid" alt="payment"></a></li>
                                    <li><a href="#"><img src="shop/assets/images/layout-1/pay/4.png" class="img-fluid" alt="payment"></a></li>
                                    <li><a href="#"><img src="shop/assets/images/layout-1/pay/5.png" class="img-fluid" alt="payment"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div>
                            <h6><span>2018 - 19</span> Copy Right by Themeforest Powered by pixel strap</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="shop/assets/images/layout-3/product/1.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="shop/assets/images/layout-3/product/2.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#"><img alt="" class="mr-3" src="shop/assets/images/layout-3/product/3.jpg"></a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                            </a>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img"><img src="shop/assets/images/layout-3/product/a3.jpg" alt="" class="img-fluid "></div>
                    </div>
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="shop/assets/images/layout-1/media-banner/1.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="shop/assets/images/layout-1/media-banner/2.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#"><img alt="" class="mr-3" src="shop/assets/images/layout-1/media-banner/3.jpg"></a>
                        <div class="media-body">
...
<!-- Add to setting bar end-->
 ...
 <!-- notification product -->
  <div class="product-notification" id="dismiss">
    ...
    <div class="media">
      <img class="mr-2" src="shop/assets/images/layout-1/product/5.jpg" alt="Generic placeholder image">
      <div class="media-body">
...
<!-- popper js-->
<script src="shop/assets/js/popper.min.js" ></script>

<!-- Timer js-->
<script src="shop/assets/js/menu.js"></script>
...
<!-- Bootstrap js-->
<script src="shop/assets/js/bootstrap-notify.min.js"></script>

<!-- Theme js-->
<script src="shop/assets/js/slider-animat-three.js"></script>
<script src="shop/assets/js/script.js"></script>
<script src="shop/assets/js/modal.js"></script>
</body>

<!-- Mirrored from themes.pixelstrap.com/bigdeal/html/layout-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 May 2020 12:59:41 GMT -->
</html>
